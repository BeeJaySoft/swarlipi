...
export const CROSS_BEAT_SAMPLES: CrossBeatSample[] = [
  { title: 'w — plain continuation', beats: ['qs', 'w', 'er'] },
  { title: 'W — stroke on a lone continuation beat', beats: ['qs', 'W', 'er'] },
  {
  ...
  { title: 'Two continuations', beats: ['qs', 'w', 'w', 'er'] },
  { title: 'W then w', beats: ['qs', 'Wr', 'w', 'er'] },
  { title: 'Adjacent beats — no w needed', beats: ['sq', 'er'] },
  {
    title: 'Unmarked gap — does not pair, so no bridge',
    beats: ['sq', 'm', 'er'],
  },
  { title: 'Ghaseet across beats', beats: ['Qs', 'w', 'Er'] },
  {
